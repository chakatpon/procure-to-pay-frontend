...
var KTFlotchartsDemo = function() {
	...
	var demo2 = function() {
		...
		var plot = $.plot($("#bbl_flotcharts_2"), [{
			data: pageviews,
			label: "Unique Visits",
			lines: {
				lineWidth: 1,
	...
	var demo3 = function() {
		...
		var plot = $.plot($("#bbl_flotcharts_3"), [{
			data: sin,
			label: "sin(x) = -0.00",
			lines: {
				lineWidth: 1,
		...
		var legends = $("#bbl_flotcharts_3 .legendLabel");
		...
		$("#bbl_flotcharts_3").bind("plothover", function(event, pos, item) {
			latestPosition = pos;
	...
	var demo4 = function() {
		...
		var plot = $.plot($("#bbl_flotcharts_4"), [getRandomData()], options);
	...
	var bbl = function() {
		...
		$.plot($("#bbl_flotcharts_7"), [data1], options);
	}
