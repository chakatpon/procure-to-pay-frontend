...
var KTGoogleMapsDemo = function() {
    ...
    var bbl = function() {
        ...
        $('#bbl_gmap_7_btn').click(function(e) {
            e.preventDefault();
            KTUtil.scrollTo('bbl_gmap_7_btn', 400);
            map.travelRoute({
                origin: [-12.044012922866312, -77.02470665341184],
                destination: [-12.090814532191756, -77.02271108990476],
                travelMode: 'driving',
                step: function(e) {
                    $('#bbl_gmap_7_routes').append('<li>' + e.instructions + '</li>');
                    $('#bbl_gmap_7_routes li:eq(' + e.step_number + ')').delay(800 * e.step_number).fadeIn(500, function() {
    ...
    var demo8 = function() {
        ...
        var handleAction = function() {
            var text = $.trim($('#bbl_gmap_8_address').val());
            GMaps.geocode({
                address: text,
                callback: function(results, status) {
                    if (status == 'OK') {
                        ...
                        KTUtil.scrollTo('bbl_gmap_8');
                    }
                }
            });
        }

        $('#bbl_gmap_8_btn').click(function(e) {
            e.preventDefault();
            handleAction();
        });

        $("#bbl_gmap_8_address").keypress(function(e) {
