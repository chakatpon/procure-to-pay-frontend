...
var KTLeaflet = function () {
	...
	var demo1 = function () {
		// define leaflet
		var leaflet = L.map('bbl_leaflet_1', {
	...
	var demo2 = function () {
		// define leaflet
		var leaflet = L.map('bbl_leaflet_2', {
	...
	var demo3 = function () {
		// define leaflet
		var leaflet = L.map('bbl_leaflet_3', {
	...
	var demo4 = function () {
		// define leaflet
		var leaflet = L.map('bbl_leaflet_4', {
			center: [51.505, -0.09],
			zoom: 13
		})
	...
	var demo5 = function () {
		// Define Map Location
		var leaflet = L.map('bbl_leaflet_5', {
	...
	var demo6 = function () {
		...
		// init leaflet map
		var leaflet = new L.Map('bbl_leaflet_6', { zoom: 10, center: new L.latLng(data[0].loc) });
