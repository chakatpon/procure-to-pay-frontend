...
var KTAppInbox = function() {
    ...
    return {
        ...
        init: function() {
            // Init variables
            _asideEl = KTUtil.getById('bbl_inbox_aside');
            _listEl = KTUtil.getById('bbl_inbox_list');
            _viewEl = KTUtil.getById('bbl_inbox_view');
            _composeEl = KTUtil.getById('bbl_inbox_compose');
            _replyEl = KTUtil.getById('bbl_inbox_reply');
        ...
        initReply: function() {
            _initEditor(_replyEl, 'bbl_inbox_reply_editor');
            _initAttachments('bbl_inbox_reply_attachments');
            _initForm('bbl_inbox_reply_form');
        },

        initCompose: function() {
            _initEditor(_composeEl, 'bbl_inbox_compose_editor');
            _initAttachments('bbl_inbox_compose_attachments');
            _initForm('bbl_inbox_compose_form');
