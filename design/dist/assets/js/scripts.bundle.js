...
var KTUtil = function() {
    ...
    return {
        ...
        actualCss: function(el, prop, cache) {
            ...
            if (!el.getAttribute('bbl-hidden-' + prop) || cache === false) {
                var value;
                ...
                // store it in cache
                el.setAttribute('bbl-hidden-' + prop, value);

                return parseFloat(value);
            } else {
                // store it in cache
                return parseFloat(el.getAttribute('bbl-hidden-' + prop));
            }
        },
	...
	return {
		init: function(id) {
			...
			if (encodeURI(window.location.hostname) == 'keenthemes.com' || encodeURI(window.location.hostname) == 'www.keenthemes.com') {
				setTimeout(function() {
		            if (!KTCookie.getCookie('bbl_app_chat_shown')) {
		                var expires = new Date(new Date().getTime() + 60 * 60 * 1000); // expire in 60 minutes from now

						KTCookie.setCookie('bbl_app_chat_shown', 1, { expires: expires });

						if (KTUtil.getById('bbl_app_chat_launch_btn')) {
							KTUtil.getById('bbl_app_chat_launch_btn').click();
						}
		            }
		        }, 2000);
	        }
...
var KTLayoutDemoPanel = function() {
    ...
    var _init = function() {
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'bbl_demo_panel_close',
            toggleBy: 'bbl_demo_panel_toggle'
        });
        ...
        if (typeof offcanvas !== 'undefined' && offcanvas.length === 0) {
            offcanvas.on('hide', function() {
                var expires = new Date(new Date().getTime() + 60 * 60 * 1000); // expire in 60 minutes from now
                KTCookie.setCookie('bbl_demo_panel_shown', 1, {expires: expires});
            });
        }
    }
    ...
    var _remind = function() {
        ...
        setTimeout(function() {
            if (!KTCookie.getCookie('bbl_demo_panel_shown')) {
...
var KTLayoutQuickActions = function() {
    ...
    var _init = function() {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'bbl_quick_actions_close',
            toggleBy: 'bbl_quick_actions_toggle'
        });
...
var KTLayoutQuickCartPanel = function() {
    ...
    var _init = function() {
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'bbl_quick_cart_close',
            toggleBy: 'bbl_quick_cart_toggle'
        });
...
var KTLayoutQuickNotifications = function() {
    ...
    var _init = function() {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'bbl_quick_notifications_close',
            toggleBy: 'bbl_quick_notifications_toggle'
        });
...
var KTLayoutQuickPanel = function() {
    ...
    var _init = function() {
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'bbl_quick_panel_close',
            toggleBy: 'bbl_quick_panel_toggle'
        });
    }
    ...
    return {
        init: function(id) {
            _element = KTUtil.getById(id);
            _notificationsElement = KTUtil.getById('bbl_quick_panel_notifications');
            _logsElement = KTUtil.getById('bbl_quick_panel_logs');
            _settingsElement = KTUtil.getById('bbl_quick_panel_settings');
...
var KTLayoutQuickSearch = function() {
    ...
    var _init = function() {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'bbl_quick_search_close',
            toggleBy: 'bbl_quick_search_toggle'
        });
...
var KTLayoutQuickUser = function() {
    ...
    var _init = function() {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'bbl_quick_user_close',
            toggleBy: 'bbl_quick_user_toggle'
        });
...
var KTLayoutAside = function() {
	...
	var _init = function() {
		...
		_offcanvasObject = new KTOffcanvas(_element, {
			...
			overlay: true,
			closeBy: 'bbl_aside_close_btn',
			toggleBy: {
				target: 'bbl_aside_mobile_toggle',
...
var KTLayoutHeaderMenu = function() {
	...
	var _init = function() {
		...
		_offcanvasObject = new KTOffcanvas(_offcanvasElement, {
			...
			closeBy: 'bbl_header_mobile_close',
			toggleBy: {
				target: 'bbl_header_mobile_toggle',
...
var KTLayoutHeaderTopbar = function() {
  console.log("KTLayoutHeaderTopbar::_init")
    // Private properties
	var _toggleElement;
    var _toggleObject;
