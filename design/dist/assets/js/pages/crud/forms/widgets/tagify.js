...
var KTTagifyDemos = function() {
    // Private functions
    var demo1 = function() {
        var input = document.getElementById('bbl_tagify_1'),
        ...
        document.getElementById('bbl_tagify_1_remove').addEventListener('click', tagify.removeAllTags.bind(tagify));
    ...
    var demo1Readonly = function() {
        // Readonly Mode
        var input = document.getElementById('bbl_tagify_1_1'),
        tagify = new Tagify(input);
    ...
    var demo2 = function() {
        var input = document.getElementById('bbl_tagify_2');
    ...
    var demo3 = function() {
        var input = document.getElementById('bbl_tagify_3');
    ...
    var demo4 = function() {
        var input = document.getElementById('bbl_tagify_4');
        var tagify = new Tagify(input, {
    ...
    var demo5 = function() {
        // Init autocompletes
        var toEl = document.getElementById('bbl_tagify_5');
    ...
    var demo6 = function() {
        var input = document.getElementById('bbl_tagify_6');
        var tagify = new Tagify(input, {
            pattern: /^.{0,20}$/, // Validate typed tag(s) by Regex. Here maximum chars length is defined as "20"
            delimiters: ", ", // add new tags when a comma or a space character is entered
            maxTags: 6,
