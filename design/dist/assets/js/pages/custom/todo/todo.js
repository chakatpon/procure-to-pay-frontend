...
var KTAppTodo = function() {
    ...
    return {
        ...
        init: function() {
            // Init variables
            _asideEl = KTUtil.getById('bbl_todo_aside');
            _listEl = KTUtil.getById('bbl_todo_list');
            _viewEl = KTUtil.getById('bbl_todo_view');
            _replyEl = KTUtil.getById('bbl_todo_reply');
        ...
        initReply: function() {
            _initEditor(_replyEl, 'bbl_todo_reply_editor');
            _initAttachments('bbl_todo_reply_attachments');
        }
    };
}();
