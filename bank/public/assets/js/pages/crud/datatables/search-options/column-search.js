...
var KTDatatablesSearchOptionsColumnSearch = function() {
    ...
    var initTable1 = function() {
        ...
        // begin first table
        var table = $('#bbl_datatable').DataTable({
            responsive: true,
            ...
            initComplete: function() {
                        ...
                        case 'Ship Date':
                            input = $(`
    							<div class="input-group date">
    								<input type="text" class="form-control form-control-sm datatable-input" readonly placeholder="From" id="bbl_datepicker_1"
    							...
    							<div class="input-group date d-flex align-content-center">
    								<input type="text" class="form-control form-control-sm datatable-input" readonly placeholder="To" id="bbl_datepicker_2"
    								 data-col-index="` + column.index() + `"/>
    								<div class="input-group-append">
    									<span class="input-group-text"><i class="la la-calendar-o glyphicon-th"></i></span>
    								</div>
                ...
                $('#bbl_datepicker_1,#bbl_datepicker_2').datepicker();
            },
            columnDefs: [{
                    targets: -1,
                    title: 'Actions',
