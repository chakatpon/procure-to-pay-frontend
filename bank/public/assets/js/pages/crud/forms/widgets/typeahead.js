...
var KTTypeahead = function() {
    ...
    var demo1 = function() {
        ...
        $('#bbl_typeahead_1, #bbl_typeahead_1_modal').typeahead({
            hint: true,
            highlight: true,
            minLength: 1
        }, {
    ...
    var demo2 = function() {
        ...
        $('#bbl_typeahead_2, #bbl_typeahead_2_modal').typeahead({
            hint: true,
            highlight: true,
            minLength: 1
        }, {
    ...
    var demo3 = function() {
        ...
        // options being used
        $('#bbl_typeahead_3, #bbl_typeahead_3_modal').typeahead(null, {
            name: 'countries',
            source: countries
        });
    }
    ...
    var demo4 = function() {
        ...
        $('#bbl_typeahead_4').typeahead(null, {
            name: 'best-pictures',
            display: 'value',
            source: bestPictures,
            templates: {
