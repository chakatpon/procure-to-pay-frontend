...
var KTamChartsMapsDemo = function() {
    ...
    var demo1 = function() {
         ...
         * Create the map
         */
        var map = AmCharts.makeChart("bbl_amcharts_1", {
            "type": "map",
            "theme": "light",
    ...
    var demo2 = function() {
        ...
        var map = AmCharts.makeChart("bbl_amcharts_2", {
            "type": "map",
            "theme": "light",
            "dataProvider": {
                "map": "worldLow",
    ...
    var demo3 = function() {
        var map = AmCharts.makeChart("bbl_amcharts_3", {
    ...
    var demo4 = function() {
         ...
         * Create the map
         */
        var map = AmCharts.makeChart("bbl_amcharts_4", {
            "type": "map",
            "theme": "light",
            "dataProvider": {
                "map": "worldLow",
    ...
    var demo5 = function() {
        var map = AmCharts.makeChart("bbl_amcharts_5", {
            "type": "map",
            "theme": "light",
            "dataProvider": {
                "map": "worldHigh",
    ...
    var demo6 = function() {
        var map = AmCharts.makeChart("bbl_amcharts_6", {
            "type": "map",
            "theme": "light",
            "colorSteps": 10,
