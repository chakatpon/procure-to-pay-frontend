    ...
    try {
      if (id.id !== "" && id.id !== undefined) {
        ...
        if (getUserDetail && getUserDetail.status === 200) {
          ...
          if (statusCode == "PFK01" || statusCode == "PFK06") {
            getReasonCode();
          }
    ...
    <div className="container">
      <div className="row bbl-font mt-3 mb-3">
        <Breadcrumb separator=">">
          ...
          <Breadcrumb.Item className="breadcrumb-item active"> {status == "PFK01" || status == "PFK06" ? "User Profile Approval" : "User Profile"}</Breadcrumb.Item>
        </Breadcrumb>
      </div>
      ...
      <div className="row justify-content-md-center">
        ...
        {(status == "PFK08" || status == "PFK09" || status == "PFK11") && isAllow("P6302", ["EDIT"]) && (
          <Button
            className="btn btn-blue mr-2"
            shape="round"
            onClick={() => {
