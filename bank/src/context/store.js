...
export const StoreContextProvider = ({ children }) => {
  ...
  const [paymentReferenceView, setPaymentReferenceView] = useState(false);
  const [buyerCodePayment, setBuyerCodePayment] = useState('');
  const [customerBatchReference, setCustomerBatchReference] = useState('');
  ...
  const store = {
    ...
    buyerCodePayment, setBuyerCodePayment,
    paymentReferenceView, setPaymentReferenceView,
    customerBatchReference, setCustomerBatchReference
  };
