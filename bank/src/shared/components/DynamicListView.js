...
const DynamicListView = (props) => {
  ...
  <div className="container-fluid">
        ...
        <section id="page-content" className="mt-5 px-10">
          ...
          {get(viewModel, "table.tableHeaderAction", []) ? get(viewModel, "table.tableHeaderAction", []).map((r) => {
              ...
              if(!isNotAllow){
                return (
                  <Button
                    ...
                    className={"btn btn-auto-width mr-3 " + get(r, "btnClass", "btn-blue")}
                  >
                    {get(r, "label", "Button")}
                  </Button>
                );
            ...
            {columnDisplay ? <TableColumnDisplay
              noneColumnDisplay={get(props,"noneColumnDisplay","")}
