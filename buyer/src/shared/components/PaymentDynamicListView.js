...
const PaymentDynamicListView = (props) => {
  ...
  const doExportData = async(config) => {
    ...
    console.log("EXPORT Pagination : ",pagination);
    let params = {
        ...
        <section id="page-content" className="mt-5 px-10">
          ...
          <Table
              ...
              rowClassName={(record, index) => {
                ...
                // }
                // Check Year.
                if(record.paymentDate && record.paymentDate.toString().substr(6, 4) < moment().format("DD-MM-YYYY").toString().substr(6, 4)){
                  console.log('full record year : ', record.paymentDate.toString())
                  console.log('full record yaer : ', moment().format("DD-MM-YYYY").toString())
                  console.log('record year : ', record.paymentDate.toString().substr(6, 4));
                  console.log('Current year : ', moment().format("DD-MM-YYYY").toString().substr(6, 4))
                  return 'text-danger'
                }
                // Check Month.
                if((record.paymentDate && record.paymentDate.toString().substr(3, 2) < moment().format("DD-MM-YYYY").toString().substr(3, 2)) &&
                   (record.paymentDate && record.paymentDate.toString().substr(6, 4) <= moment().format("DD-MM-YYYY").toString().substr(6, 4))){
                  console.log('full record month : ', record.paymentDate.toString())
                  console.log('full record month : ', moment().format("DD-MM-YYYY").toString())
                  console.log('record month : ', record.paymentDate.toString().substr(3, 2));
                  console.log('Current month : ', moment().format("DD-MM-YYYY").toString().substr(3, 2))
                  return 'text-danger'
                }
                // Check Day.
                if(record.paymentDate && record.paymentDate.toString().substr(0, 2) < moment().format("DD-MM-YYYY").toString().substr(0, 2) &&
                  (record.paymentDate && record.paymentDate.toString().substr(3, 2) <= moment().format("DD-MM-YYYY").toString().substr(3, 2)) &&
                  (record.paymentDate && record.paymentDate.toString().substr(6, 4) <= moment().format("DD-MM-YYYY").toString().substr(6, 4))){
                  console.log('full record date : ', record.paymentDate.toString())
                  console.log('full record date : ', moment().format("DD-MM-YYYY").toString())
                  console.log('record date : ', record.paymentDate.toString().substr(0, 2));
                  console.log('Current date : ', moment().format("DD-MM-YYYY").toString().substr(0, 2))
                  return 'text-danger'
                }
                return ''
              }}
...
export default PaymentDynamicListView;
