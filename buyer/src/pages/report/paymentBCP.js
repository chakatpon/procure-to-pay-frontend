...
const paymentBCP = (props) => {
  ...
  const getData = async (page, pageSize, sortList, searchList, limitOptions, flagShowTotalSum) => {
    ...
    let list = await AppApi.getApi(
      "/p2p/api/v1/inquiry/report/paymentBCP",
      {
    ...
    if (list.status == 200) {
      ...
      const summaryData = get(list, "data.summary", []) == null ? [] : get(list, "data.summary", [])
  ...
  const prepareData = async (searchList) => {
    try {
      ...
      listView = await AppApi.getApi("/p2p/api/v1/template/report/paymentBCP", {}, { method: "post", authorized: true });
      ...
      <div className="container-fluid px-0">
        <DynamicListReport
          ...
          columnDisplaySummary={{
            ...
            get: "/p2p/api/v1/template/report/paymentBCP/summary/column/get",
            set: "/p2p/api/v1/template/report/paymentBCP/summary/column/set",
            default: "/p2p/api/v1/template/report/paymentBCP/summary/column/default",
          }}
          columnDisplayDetail={{
            onChange: OnTableColumnDetailDisplayChange,
            onReset: OnTableColumnDetailDisplayReset,
            get: "/p2p/api/v1/template/report/paymentBCP/detail/column/get",
            set: "/p2p/api/v1/template/report/paymentBCP/detail/column/set",
            default: "/p2p/api/v1/template/report/paymentBCP/detail/column/default",
          }}
        />
      </div>
    </>
