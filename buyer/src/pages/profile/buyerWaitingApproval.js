...
export default function buyerWaitingApproval(props) {
    ...
    const dataSourceActionHistory = actionHistory;
    ...
    const onApproved = async () => {
        ...
        showLoading("Loading")
        await AppApi.getApi('p2p/api/v1/approve/buyer/profile', {
            "proposalId": id
        }, {
            method: "post", authorized: true,
        }).then(async (res) => {
                ...
                <div className="container">
                    ...
                    <div id="box-header" className="col-12 mb-10">
                        ...
                        <Breadcrumb separator=">">
                            ...
                            <Breadcrumb.Item className="breadcrumb-item">
                                <a href='/profile/buyerApprovalLists/'>
