...
var KTFormWidgetsValidation = function () {
    ...
    var _initWidgets = function() {
        ...
        // Datetimepicker
        $('#bbl_datetimepicker').datetimepicker({
        ...
        $('#bbl_datetimepicker').change(function() {
            // Revalidate field
            validator.revalidateField('datetime');
        });

        // Timepicker
        $('#bbl_timepicker').timepicker({
            minuteStep: 1,
            showSeconds: true,
            showMeridian: true
        });

        $('#bbl_timepicker').change(function() {
            // Revalidate field
            validator.revalidateField('time');
        });

        // Daterangepicker
        $('#bbl_daterangepicker').daterangepicker({
            buttonClasses: ' btn',
            applyClass: 'btn-primary',
            cancelClass: 'btn-light-primary'
        }, function(start, end, label) {
            var input = $('#bbl_daterangepicker').find('.form-control');
        ...
        // Bootstrap Select
        $('#bbl_bootstrap_select').selectpicker();
        $('#bbl_bootstrap_select').on('changed.bs.select', function() {
            // Revalidate field
        ...
        $('#bbl_select2').on('change', function(){
            // Revalidate field
        ...
        $('#bbl_typeahead').typeahead(null, {
            name: 'countries',
            source: countries
        });

        $('#bbl_typeahead').bind('typeahead:select', function(ev, suggestion) {
            // Revalidate field
    ...
    var _initValidation = function () {
        ...
        validator = FormValidation.formValidation(
            document.getElementById('bbl_form'),
            {
                fields: {
                    date: {
                        validators: {
