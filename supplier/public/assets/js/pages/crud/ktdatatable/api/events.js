...
var KTDefaultDatatableDemo = function() {
	...
	var demo = function() {
		...
		var datatable = $('#bbl_datatable').KTDatatable({
	...
	$('#bbl_datatable_clear').on('click', function() {
		$('#bbl_datatable_console').val('');
	});

	var eventsCapture = function() {
		$('#bbl_datatable').on('datatable-on-init', function() {
	...
	var eventsWriter = function(string) {
		var console = $('#bbl_datatable_console');
