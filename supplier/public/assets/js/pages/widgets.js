...
var KTWidgets = function () {
    ...
    var _initDaterangepicker = function () {
        if ($('#bbl_dashboard_daterangepicker').length == 0) {
            return;
        }

        var picker = $('#bbl_dashboard_daterangepicker');
        var start = moment();
        var end = moment();
        ...
        function cb(start, end, label) {
            ...
            $('#bbl_dashboard_daterangepicker_date').html(range);
            $('#bbl_dashboard_daterangepicker_title').html(title);
        }
    ...
    var _initStatsWidget7 = function () {
        var element = document.getElementById("bbl_stats_widget_7_chart");
    ...
    var _initStatsWidget8 = function () {
        var element = document.getElementById("bbl_stats_widget_8_chart");
    ...
    var _initStatsWidget9 = function () {
        var element = document.getElementById("bbl_stats_widget_9_chart");
    ...
    var _initStatsWidget10 = function () {
        var element = document.getElementById("bbl_stats_widget_10_chart");
    ...
    var _initStatsWidget11 = function () {
        var element = document.getElementById("bbl_stats_widget_11_chart");
    ...
    var _initStatsWidget12 = function () {
        var element = document.getElementById("bbl_stats_widget_12_chart");
    ...
    var _initChartsWidget1 = function () {
        var element = document.getElementById("bbl_charts_widget_1_chart");
    ...
    var _initChartsWidget2 = function () {
        var element = document.getElementById("bbl_charts_widget_2_chart");
    ...
    var _initChartsWidget3 = function () {
        var element = document.getElementById("bbl_charts_widget_3_chart");
    ...
    var _initChartsWidget4 = function () {
        var element = document.getElementById("bbl_charts_widget_4_chart");
    ...
    var _initChartsWidget5 = function () {
        var element = document.getElementById("bbl_charts_widget_5_chart");
    ...
    var _initChartsWidget6 = function () {
        var element = document.getElementById("bbl_charts_widget_6_chart");
    ...
    var _initChartsWidget7 = function () {
        var element = document.getElementById("bbl_charts_widget_7_chart");
    ...
    var _initChartsWidget8 = function () {
        var element = document.getElementById("bbl_charts_widget_8_chart");
    ...
    var _initChartsWidget9 = function () {
        var element = document.getElementById("bbl_charts_widget_9_chart");
    ...
    var _initMixedWidget1 = function () {
        var element = document.getElementById("bbl_mixed_widget_1_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
    ...
    var _initMixedWidget2 = function () {
        var element = document.getElementById("bbl_mixed_widget_2_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
    ...
    var _initMixedWidget3 = function () {
        var element = document.getElementById("bbl_mixed_widget_3_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
    ...
    var _initMixedWidget4 = function () {
        var element = document.getElementById("bbl_mixed_widget_4_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
    ...
    var _initMixedWidget5 = function () {
        var element = document.getElementById("bbl_mixed_widget_5_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
    ...
    var _initMixedWidget6 = function () {
        var element = document.getElementById("bbl_mixed_widget_6_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
    ...
    var _initMixedWidget13 = function () {
        var element = document.getElementById("bbl_mixed_widget_13_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
    ...
    var _initMixedWidget14 = function () {
        var element = document.getElementById("bbl_mixed_widget_14_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
    ...
    var _initMixedWidget15 = function () {
        var element = document.getElementById("bbl_mixed_widget_15_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
    ...
    var _initMixedWidget16 = function () {
        var element = document.getElementById("bbl_mixed_widget_16_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
    ...
    var _initMixedWidget17 = function () {
        var element = document.getElementById("bbl_mixed_widget_17_chart");
    ...
    var _initMixedWidget18 = function () {
        var element = document.getElementById("bbl_mixed_widget_18_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
    ...
    var _initTilesWidget1 = function () {
        var element = document.getElementById("bbl_tiles_widget_1_chart");
        var color = KTUtil.hasAttr(element, 'data-color') ? KTUtil.attr(element, 'data-color') : 'primary';
        var height = parseInt(KTUtil.css(element, 'height'));
    ...
    var _initTilesWidget2 = function () {
        var element = document.getElementById("bbl_tiles_widget_2_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
    ...
    var _initTilesWidget5 = function () {
        var element = document.getElementById("bbl_tiles_widget_5_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
    ...
    var _initTilesWidget8 = function () {
        var element = document.getElementById("bbl_tiles_widget_8_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
    ...
    var _initTilesWidget17 = function () {
        var element = document.getElementById("bbl_tiles_widget_17_chart");
    ...
    var _initTilesWidget20 = function () {
        var element = document.getElementById("bbl_tiles_widget_20_chart");
    ...
    var _initMixedWidget21 = function () {
        var element = document.getElementById("bbl_tiles_widget_21_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
        var color = KTUtil.hasAttr(element, 'data-color') ? KTUtil.attr(element, 'data-color') : 'info';
    ...
    var _initMixedWidget23 = function () {
        var element = document.getElementById("bbl_tiles_widget_23_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
        var color = KTUtil.hasAttr(element, 'data-color') ? KTUtil.attr(element, 'data-color') : 'primary';
    ...
    var _initFormsWidget1 = function() {
        var inputEl = KTUtil.getById("bbl_forms_widget_1_input");
    ...
    var _initFormsWidget2 = function() {
        var formEl = KTUtil.getById("bbl_forms_widget_2_form");
        var editorId = 'bbl_forms_widget_2_editor';

        // init editor
        var options = {
            modules: {
                toolbar: {
                    container: "#bbl_forms_widget_2_editor_toolbar"
                }
            },
    ...
    var _initFormsWidget3 = function() {
        var inputEl = KTUtil.getById("bbl_forms_widget_3_input");
    ...
    var _initFormsWidget4 = function() {
        var inputEl = KTUtil.getById("bbl_forms_widget_4_input");
    ...
    var _initFormsWidget5 = function() {
        var inputEl = KTUtil.getById("bbl_forms_widget_5_input");
    ...
    var _initFormsWidget6 = function() {
        var inputEl = KTUtil.getById("bbl_forms_widget_6_input");
    ...
    var _initFormsWidget7 = function() {
        var inputEl = KTUtil.getById("bbl_forms_widget_7_input");
    ...
    var _initFormsWidget8 = function() {
        var inputEl = KTUtil.getById("bbl_forms_widget_8_input");
    ...
    var _initFormsWidget9 = function() {
        var inputEl = KTUtil.getById("bbl_forms_widget_9_input");
    ...
    var _initFormsWidget10 = function() {
        var inputEl = KTUtil.getById("bbl_forms_widget_10_input");
    ...
    var _initFormsWidget11 = function() {
        var inputEl = KTUtil.getById("bbl_forms_widget_11_input");
    ...
    var _initFormsWidget12 = function() {
        var inputEl = KTUtil.getById("bbl_forms_widget_12_input");
    ...
    var _initEducationShowMoreBtn = function() {
        var el = KTUtil.getById('bbl_app_education_more_feeds_btn');
    ...
    return {
        init: function () {
            ...
            // Table Widgets
            _initAdvancedTableGroupSelection('bbl_advance_table_widget_1');
            _initAdvancedTableGroupSelection('bbl_advance_table_widget_2');
            _initAdvancedTableGroupSelection('bbl_advance_table_widget_3');
            _initAdvancedTableGroupSelection('bbl_advance_table_widget_4');

            // Form Widgets
            _initPriceSlider('bbl_price_slider');
