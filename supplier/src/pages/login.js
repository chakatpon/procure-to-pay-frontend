...
export default function Login(props) {
  ...
  const { showLoading, hideLoading, showAlertDialog, setAppMenu, appMenu, getStorage, setStorage, loginUser, setLoginUser, isLogin, setIsLogin,forceChangePassword } = useContext(StoreContext);
        ...
        <div className="col-8 mx-auto d-flex flex-wrap login-form p-0 position-relative overflow-hidden">
          ...
          <div id="formContent" className="col-6 login-signin p-8 d-flex">
            <div className="col-12 px-0 align-self-center">
              ...
              <h3 className="mb-4 font-weight-bolder text-center">{t("Login to Supplier")}</h3>
