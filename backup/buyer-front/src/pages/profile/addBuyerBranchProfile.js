...
import { Form, Button, Modal, Radio, Result } from 'antd';
import TextField from '@material-ui/core/TextField';

import { BLOCK_UI, UNBLOCK_UI } from '../../../constant/login';

function addBuyerBranchProfile(props) {
            ...
            <div className="col-7">
                ...
                <div>
                    <div className="row bbl-font mt-3">
                        ...
                        {'>'} &nbsp;
                            <a href='/profile/buyerDetail/' style={{ color: "#000" }}>
                            {branch} Detail &nbsp;
                        </a>
                        {'>'} &nbsp;
                            <a>
                            <div className="bbl-font-bold">
                                Create New {branch} Branch Profile
                            </div>
                        </a>
                    </div>
                    ...
                    >
                        <div className="mt-1">
                            <p className="text-center" style={{ fontSize: "17px" }}>
                                Please comfirm to Create Branch Profile
                            </p>
                    ...
                    >
                        <Result
                            ...
                            title={
                                <p>
                                    Create new Branch Profile Successfully.
                                </p>
                            }
                        />
                    </Modal>
...
export default connect(mapStateToProps, mapDispatchToProps)(addBuyerBranchProfile);
