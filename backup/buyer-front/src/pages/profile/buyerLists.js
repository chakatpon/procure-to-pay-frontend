    ...
    const BuyerColumns = [
        ...
        },
        {
            ...
            render: (text, record, index) => (
                <Link
                    onClick={() => blockUI()}
                    href={`/profile/buyerDetail?mode=edit&mpfId=${text}`}
                    as="/profile/buyerDetail"
                    style={{ color: "blue" }}
                >
                    {text}
                </Link>
        ...
        },
        {
            ...
            sorter: {
                compare: (a, b) => a.supplierList - b.supplierList,
            },
        }
    ]
...
export default connect(mapStateToProps, mapDispatchToProps)(buyerLists);
